 ...
 * property it names. Bulb color follows the chosen scheme.
 */
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        />
        <path
          d="M96 340 L58 300 M96 350 L134 312 M96 316 L72 286 M96 322 L124 292"
          stroke={S}
          strokeWidth="4"
          strokeLinecap="round"
          fill="none"
        ...
        />
        <path
          d="M812 350 L780 316 M812 358 L846 322 M812 328 L792 302"
          stroke={S}
          strokeWidth="3.5"
          strokeLinecap="round"
          fill="none"
      ...
      {[
        ...
        <Run
          ...
          points={Array.from({ length: 13 }, (_, i) => {
            ...
            return [cx + Math.cos(a) * rx, cy + Math.sin(a) * ry] as [
              number,
              number,
            ];
          })}
