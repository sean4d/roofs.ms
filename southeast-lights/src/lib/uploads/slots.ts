...
export const SLOTS: Slot[] = [
  ...
  {
    key: "landscape-lighting-hero",
    label: "Landscape lighting, uplit tree",
    where: "Landscape Lighting card and service hero",
    group: "Services",
  },
  {
    key: "bistro-patio",
  ...
  {
    key: "project-poplarville-red-green-white",
    label: "Poplarville red, green and white",
    where: "Gallery project, Poplarville",
    group: "Projects",
  },
  {
    key: "project-poplarville-outbuildings",
    label: "Poplarville outbuildings",
    where: "Gallery project, Poplarville",
    group: "Projects",
  },
  {
    key: "project-poplarville-apples",
    label: "Apples Ltd. storefront",
    where: "Gallery project, Poplarville commercial",
    group: "Projects",
  },
  {
    key: "project-poplarville-halloween",
    label: "Poplarville Halloween",
    where: "Gallery project and Halloween service page",
    group: "Projects",
  },
  {
    key: "project-hattiesburg-two-story",
    label: "Hattiesburg two-story gallery",
    where: "Gallery project, Hattiesburg",
    group: "Projects",
  },
  {
    key: "project-hattiesburg-canopy",
    label: "Hattiesburg wooded lot",
  ...
  {
    key: "project-hattiesburg-low-wide",
    label: "Hattiesburg low wide roof",
    where: "Gallery project, Hattiesburg",
    group: "Projects",
  },
  {
    key: "project-hattiesburg-low-wide-angle",
    label: "Hattiesburg low wide roof, angle",
    where: "Gallery project photo",
    group: "Projects",
  },
  {
    key: "project-pearsons-front",
    label: "Pearson's Barber Shop",
    where: "Gallery project, Poplarville commercial",
    group: "Projects",
  },
  {
    key: "project-pearsons-block",
    label: "Pearson's Barber Shop, block",
    where: "Gallery project photo",
    group: "Projects",
  },
  {
    key: "project-poplarville-continuous-run",
    label: "Poplarville continuous run",
    where: "Gallery project, Poplarville",
    group: "Projects",
  },
  {
    key: "project-hattiesburg-clean-line",
    label: "Hattiesburg clean line",
    where: "Gallery project, Hattiesburg",
    group: "Projects",
  },
  {
